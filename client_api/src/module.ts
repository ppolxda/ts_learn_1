...
export class ErrorInfo extends DataModule {
  ...
  static readonly fkeys: string[] = ["error", "error_text"];
...
export class NullRsp extends DataModule {
  ...
  static readonly fkeys: string[] = ["error"];
...
export class DefaultQuery extends DataModule {
  ...
  static readonly fkeys: string[] = ["where", "sort", "csv", "show"];
...
export class DefaultHeader extends DataModule {
  ...
  static readonly fkeys: string[] = ["token"];
...
export class Contact extends DataModule {
  ...
  static readonly fkeys: string[] = ["phone", "email"];
...
export class CreateUserReqIdCard extends DataModule {
  ...
  static readonly fkeys: string[] = ["cardno", "cardtype"];
...
export class CreateUserQuery extends DataModule {
  ...
  static readonly fkeys: string[] = ["is_debug", "rnd"];
...
export class GetUsersRsp extends DataModule {
  ...
  static readonly fkeys: string[] = ["error", "datas"];
...
export abstract class RestFulApis {
  ...
  public CreateUserHttp(
    datas: CreateUserReq,
    querys: CreateUserQuery,
    ...
    return axios
      .post<NullRsp>(`${this.nginx_uri}/user/create`, config)
      .then(rsp => {
        this.CheckError(rsp);
        return rsp.data;
      });
  ...
  public GetUserHttp(
    ...
    return axios
      .get<GetUsersRsp>(`${this.nginx_uri}/user/users`, config)
      .then(rsp => {
        this.CheckError(rsp);
        return rsp.data;
      });
